    ...
    mutate(
      ...
      },
      {
        onSuccess() {
          ...
          const message = `We are sorry to hear ${application?.first_name} that you are not able to accept you for application for ${course?.title}. Please proceed to admission table and ask for assistance.`;
          const contact_number = application?.contact_number;
          if (contact_number)
            sendBulkSms(message, [contact_number], "Disciplr");
        },
